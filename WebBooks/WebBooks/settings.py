...
SECRET_KEY = 'django-insecure-r6mv^^#eb02c+#cbh9!mxvj!fftq2ogjz1p0(hj0*^zqma7w5i'
...
EMAIL_PORT = 465
EMAIL_HOST_USER = "rusweb96@gmail.com"  # от кого
EMAIL_HOST_PASSWORD = "xnzkuzqepsdralgt "  # пароль почты отправителя
